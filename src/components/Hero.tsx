    ...
    return (
        <section id="home" className="min-h-[100vh] bg-white ">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-28 text-center">
                {/* Main Headline */}
                <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-black leading-tight tracking-tight">
                    Define Your <span className="text-gray-400">Style.</span>
                </h1>

                {/* Subheading */}
                <p className="mt-8 text-lg sm:text-xl md:text-2xl text-gray-600 leading-relaxed max-w-2xl mx-auto font-medium">
                ...
                <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
                    ...
                    <a href="#collections" className="inline-block w-full sm:w-auto px-10 py-4 bg-white border-2 border-black text-black font-bold text-lg rounded-full hover:bg-gray-50 transition transform hover:-translate-y-1">
                        View Collections
                    </a>
                </div>

                {/* Optional subtle stats below */}
                <div className="mt-16 pt-8 border-t border-gray-100 flex flex-wrap justify-center gap-8 sm:gap-16 text-gray-500">
